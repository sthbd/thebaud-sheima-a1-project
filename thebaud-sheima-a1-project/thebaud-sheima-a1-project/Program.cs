...
Console.Write("\nIT IS 2 AM, YOU LIVE BY YOURSELF IN A ONE BEDROOM APARTMENT AND YOU HAD JUST FINISHED YOUR HOMEWORK FOR TODAY.\n");
...
Console.WriteLine("HOWEVER, YOU DON'T FEEL LIKE YOU WANT TO SPEND YOUR MONEY ON FOOD. YOU HAVE LEFTOVER LASAGNA IN THE FRIDGE WAITING FOR YOU.");
...

{
    ...
    {
        Console.WriteLine("\nYOU DECIDE TO STAY HOME AND ENJOY YOUR LEFTOVER. MORE MONEY IN YOUR POCKET.");
        Console.WriteLine("\nYOU DIRECT YOURSELF TO THE FRIDGE, TAKE THE LASAGNA, AND HEAT IT UP.\n");
        Console.WriteLine("WHILE YOU'RE WAITING FOR YOUR FOOD, YOU ARE HEARING WEIRD NOISES COMING FROM YOUR BEDROOM.\n");
    ...
    if (NoYes == "YES" || NoYes == "yes")
    {
        ...
        Console.WriteLine("\nAS YOU WERE ABOUT TO HEAD BACK TO THE KITCHEN, A SUDDEN RED DROPLET OF BLOOD LANDS ON YOUR CARPET.\n");
    ...
    else if (NoYes == "NO" || NoYes == "no")
    {
        ...
        Console.WriteLine("\nYOU ARE STARING TO THE POINT YOU ARE LOSING YOURSELF IN THE YELLOW LIGHT OF THE MICROWAVE.\n");
        ...
        Console.WriteLine("\nSO LONG THAT YOU FINALLY SNAP OUT OF IT, REALIZING YOUR FOOD IS READY.\n");
    ...
    if (YesNo == "NO" || YesNo == "no")
    {
        ...
        Console.WriteLine("\nYOU LOOK AT THE BURGER, AND IT COST 5.00 $ MEANWHILE, THE SUSHI WILL COST YOU 10.00 $\n");
    ...
    if (BurSush == "BURGER" || BurSush == "burger")
    {
        ...
        Console.WriteLine("\nYOUR TOTAL IS  5.00 $ \n");
        Console.WriteLine("\nYOU PROCEED TO DIG IN YOUR POCKET TO REACH YOUR WALLET. THE CASHIER THEN STARTS TO ENGAGE IN A CONVERSATION AS YOU ARE LOOKING FOR YOUR CHANGE.\n");
        Console.WriteLine("\nTHE MORE HE WOULD SPEAK, THE MORE IT IRRITATED YOU. HE KEEPS ON TALKING AS YOU ARE UNABLE TO REACH THE LAST 25 CENTS TO COMPLETE YOUR CHANGE.\n");
        Console.WriteLine("\nFINALLY, YOU SLAM THE CHANGE ON THE COUNTER AND YELL AT THE CASHIER TO SHUT UP AND GIVE YOU YOUR BURGER.\n");
    ...
    else if (BurSush == "SUSHI" || BurSush == "sushi")
    {
        ...
        Console.WriteLine("\n...YOU FORGOT YOUR WALLET RIGHT AT THE ENTRANCE OF YOUR DOOR.\n");
